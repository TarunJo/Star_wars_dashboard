              ...
              <div class="main-container">
                ...
                <div class="desc-container">
                  ...
                  <div class="about-more" onClick={handleContextMenu}>
                    ...
                    {
                      deleteMenu1 && <Delete deleteMenu={setDeleteMenu1} data={species} index={whichDelete}></Delete>
                    }
                ...
                <tr class={ind === 0 ? "" : "data-tr"}>
                  ...
                  <td class="data-td">
                    <div class="table-more" onClick={handleContextMenu}>
                      ...
                      {
                        deleteMenu2 && <Delete deleteMenu={setDeleteMenu2} data={species} index={whichDelete}></Delete>
                      }
                    </div>
                  </td>
                </tr>
